    ...
    <section className="py-16 md:py-32" aria-labelledby="pricing-comparison-heading" id="comparison">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mt-8 flex flex-col items-center gap-8">
          <div className="w-full rounded-3xl border border-border/40 bg-background/90 px-4 py-6 text-center shadow-lg md:hidden">
            <p className="text-base text-muted-foreground">
              The full comparison looks best on a larger screen. Switch to desktop or tablet to see every detail.
            </p>
